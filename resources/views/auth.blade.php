            ...
            <form action="{{ route('login') }}" method="POST" style="display: flex; flex-direction: column; gap: 20px;">
                ...
                <div>
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
                        <label model_for="password" style="font-size: 13px; font-weight: 600; color: var(--ink);">Kata Sandi</label>
                ...
                <div style="margin-top: 8px;">
                    <button type="submit" class="btn-primary" style="width: 100%; padding: 14px; font-size: 15px; border-radius: 12px; font-weight: 700; cursor: pointer; border: none;">
                        Masuk ke Platform
                    </button>
                </div>
            </form>
