    ...
    <div class="dashboard-wrapper">
        ...
        <aside id="main-sidebar" class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="{{ route('guru.konsultasi') }}" class="{{ request()->routeIs('guru.konsultasi') ? 'active' : '' }}">
                        <svg class="menu-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                        </svg>
                        <span>Ruang Konsultasi BK</span>
                    </a>
                </li>
                <li>
                ...
                <li class="nav-item" style="margin-top: 24px;">
                    <a href="{{ route('guru.panduan') }}" class="nav-link {{ request()->routeIs('guru.panduan') ? 'active' : '' }}">
